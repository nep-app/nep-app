...
export const AnalysesCoachTab = React.memo(function AnalysesCoachTab({
    ...
    return (
        <div className="space-y-3">
            {/* Header */}
            <div className={'bg-gradient-to-r from-purple-900/30 to-pink-900/30 border-purple-700/50 rounded-xl p-5 border'}>
                <div className="flex items-center gap-3 mb-1">
                    <span className="text-3xl">💬</span>
                    <h3 className={'text-xl font-bold text-white'}>{t('coach.title')}</h3>
                </div>
                <p className={'text-xs text-gray-400'}>{t('coach.subtitle')}</p>
            </div>
            ...
            {openSections.resumo && (
                <div className={'bg-gray-800 border-gray-700 rounded-xl p-5 border space-y-4 leading-relaxed text-gray-200'}>
                    ...
                    {/* Micro-trend (📈 last 7 vs previous 21) */}
                    {(() => {
