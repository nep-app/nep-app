                                                    ...
                                                    {Object.keys(byDate).length >= 7 && (() => {
                                                        ...
                                                        return (
                                                            <div className={(darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200') + ' rounded-xl p-4 border mt-4'}>
                                                                <h3 className={'font-semibold mb-4 ' + (darkMode ? 'text-purple-300' : 'text-gray-800')}>📅 Padrão Semanal</h3>
                                                                <div className="space-y-3">
                                                                        ...
                                                                        return (
                                                                            <div key={day} className="space-y-1">
                                                                                <div className="flex items-center justify-between text-sm">
                                                                                    <div className="flex items-center gap-2">
                                                                                        <span className={'font-medium w-8 ' + (darkMode ? 'text-gray-300' : 'text-gray-700')}>{dayNames[day]}</span>
                                                                                    ...
                                                                                    <span className={'font-semibold ' + (darkMode ? 'text-purple-400' : 'text-purple-600')}>{avg.toFixed(1)}/dia</span>
                                                                                </div>
                                                                                <div className={(darkMode ? 'bg-gray-700' : 'bg-gray-200') + ' rounded-full h-2 overflow-hidden'}>
                                                                                    <div className={'h-full rounded-full transition-all duration-500 ' + (isBest ? 'bg-gradient-to-r from-green-500 to-emerald-500' : isWorst ? 'bg-gradient-to-r from-red-500 to-orange-500' : avg > 8 ? 'bg-gradient-to-r from-orange-500 to-yellow-500' : avg > 5 ? 'bg-gradient-to-r from-blue-500 to-cyan-500' : 'bg-gradient-to-r from-purple-500 to-blue-500')} style={{ width: `${widthPercent}%` }}></div>
                                                                                </div>
                                                                                <div className={'text-xs ' + (darkMode ? 'text-gray-500' : 'text-gray-400')}>{dayData[day].length} {dayData[day].length === 1 ? 'dia' : 'dias'} registados</div>
                                                                            </div>
                                                                        );
                                                                    })}
                                                                </div>
                                                                <div className={'mt-4 pt-4 border-t text-sm ' + (darkMode ? 'border-gray-700' : 'border-gray-200')}>
                                                                    <p className={darkMode ? 'text-gray-300' : 'text-gray-700'}>
                                                                        <span className={'font-semibold ' + (darkMode ? 'text-green-400' : 'text-green-600')}>{dayNames[bestDay.day]}s</span> são teu ponto forte ({bestDay.avg.toFixed(1)}/dia).
                                                                        <span className={'font-semibold ml-1 ' + (darkMode ? 'text-red-400' : 'text-red-600')}>{dayNames[worstDay.day]}s</span> são mais desafiantes ({worstDay.avg.toFixed(1)}/dia).
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        );
