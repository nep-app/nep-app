...
export const PatternsView = () => {
    ...
    // Helper proxies to analyticsService
                ...
                if (patternView === 'progress') {
                    ...
                    if (recentSleepValues.length > 0 || previousSleepValues.length > 0) {
                        ...
                        progressData.sleep = {
                            ...
                            change: calculateChange(recentAvgSleep, previousAvgSleep, false),
                    ...
                    if (recentMoodLogs.length > 0 || previousMoodLogs.length > 0) {
                        ...
                        progressData.mood = {
                            ...
                            change: calculateChange(recentAvgMood, previousAvgMood, false),
                            label: 'Humor médio'
                        };
                    }
                    ...
                    if (recentEnergyLogs.length > 0 || previousEnergyLogs.length > 0) {
                        ...
                        progressData.energy = {
                            ...
                            change: calculateChange(recentAvgEnergy, previousAvgEnergy, false),
                            label: 'Energia média'
                        };
                    }
                    ...
                    if (recentCycles.length > 0 || previousCycles.length > 0) {
                        ...
                        const minutesToTime = (mins) => {
                            const adjustedMins = mins >= 1440 ? mins - 1440 : mins;
                        ...
                        if (recentBedtimes.length > 0 || previousBedtimes.length > 0) {
                            ...
                            progressData.bedtimeConsistency = {
                                ...
                                change: calculateChange(recentStdDev, previousStdDev, true),
                    ...
                    if (recentSelfCareActivities.length > 0 || previousSelfCareActivities.length > 0) {
                        ...
                        progressData.selfCare = {
                            ...
                            change: calculateChange(recentAvgSelfCare, previousAvgSelfCare, false),
                    ...
                    if (recentNegativeCount > 0 || previousNegativeCount > 0) {
                        ...
                        progressData.negativeEmotions = {
                            ...
                            change: calculateChange(recentNegativePercent, previousNegativePercent, true),
                    ...
                    if (recentTriggers.length > 0 || previousTriggers.length > 0) {
                        ...
                        progressData.triggers = {
                            ...
                            change: calculateChange(recentAvgTriggers, previousAvgTriggers, true),
