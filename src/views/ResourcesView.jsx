    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-red-50 rounded-xl p-6 border border-red-200">
                <h3 className="font-semibold text-red-800 mb-3">🚨 Emergência</h3>
                <div className="space-y-2 text-red-700">
                    <p><strong>INEM:</strong> 112</p>
                    <p><strong>Linha Vida:</strong> 1414</p>
                </div>
            </div>
                ...
                <div className={'space-y-3 ' + (darkMode ? 'text-gray-300' : 'text-gray-700')}>
                    ...
                    {notificationsEnabled ? (
                        ...
                        <button
                            ...
                            className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white py-3 rounded-lg hover:from-blue-600 hover:to-purple-600 transition-all font-medium"
                        >
                            Ativar Notificações
                        </button>
                    )}
            ...
            {educationalResources.map((resource, i) => (
                <div key={i} className="bg-purple-50 rounded-xl p-4 border border-purple-200">
                    <h4 className="font-medium text-purple-800 mb-2">{resource.title}</h4>
                    <p className="text-sm text-purple-700">{resource.content}</p>
                </div>
            ))}
        </div>
    );
