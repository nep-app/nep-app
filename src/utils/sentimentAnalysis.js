...
function _calculateRawSentiment(text) {
  ...
  const POSITIVE_WORDS_RAW = {
    ...
    'progresso': 1, 'sobrevivi': 1, 'safe': 1, 'beca': 1, 'finalmente': 1, 'melhorzinho': 1, 'decente': 1, 'estavel': 1
  };
  ...
  const NEGATIVE_WORDS_RAW = {
    ...
    'desconcentrado': 1, 'desconcentrada': 1, 'distraido': 1, 'distraida': 1, 'desanimado': 1, 'desanimada': 1
  };
