 ...
 * limitations under the License.
 */
const H="firebase-installations-store";let W=null;function U(){return W||(W=o("firebase-installations-database",1,{upgrade:(e,t)=>{0===t&&e.createObjectStore(H)}})),W}async function L(e,t){const n=$(e),i=(await U()).transaction(H,"readwrite"),a=i.objectStore(H),o=await a.get(n);return await a.put(t,n),await i.done,o&&o.fid===t.fid||F(e,t.fid),t}async function V(e){const t=$(e),n=(await U()).transaction(H,"readwrite");await n.objectStore(H).delete(t),await n.done}async function B(e,t){const n=$(e),i=(await U()).transaction(H,"readwrite"),a=i.objectStore(H),o=await a.get(n),r=t(o);return void 0===r?await a.delete(n):await a.put(r,n),await i.done,!r||o&&o.fid===r.fid||F(e,r.fid),r}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function z(e){let t;const n=await B(e.appConfig,n=>{const i=function(e){return Q(e||{fid:N(),registrationStatus:0})}(n),a=function(e,t){if(0===t.registrationStatus){if(!navigator.onLine)return{installationEntry:t,registrationPromise:Promise.reject(D.create("app-offline"))};const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},i=async function(e,t){try{const n=
/**
 * @license
 * Copyright 2019 Google LLC
 *
