const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-ChEmZbUq.js","assets/vendor-react-C_6PPKRX.js","assets/vendor-firebase-BBjUxxCC.js","assets/index-BmRzizEH.css"])))=>i.map(i=>d[i]);
import{v as e,w as t,x as s,y as a,u as n,z as i,j as r,D as o,F as c,S as l,G as d,U as u,_ as g,L as p,R as m,I as f,J as h,K as x,M as b,c as y,N as w,O as v}from"./index-ChEmZbUq.js";import{r as j}from"./vendor-react-C_6PPKRX.js";import{r as N,_ as k,C as S,p as C,E as I,t as T,F as D,v as O,u as A,x as E,y as _,z as P,A as M,s as K,d as H,h as L}from"./vendor-firebase-BBjUxxCC.js";const R="@firebase/installations",q="0.6.9",$=`w:${q}`,F="FIS_v2",W=new I("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function B(e){return e instanceof D&&e.code.includes("request-failed")}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t)?t:null}(e.appConfig.senderId);if(t)return await _e(e,t),t}}async function _e(e,t){const s=Pe(e),a=(await Ae()).transaction(De,"readwrite");return await a.objectStore(De).put(t,s),await a.done,t}function Pe({appConfig:e}){return e.appId}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
async function ze(){try{await O()}catch(e){return!1}return"undefined"!=typeof window&&A()&&E()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qe(e){return async function(e){if(!navigator)throw Me.create("only-available-in-window");return e.swRegistration||await Be(e),async function(e){const t=await Ee(e.firebaseDependencies);t&&(await Ke(e.firebaseDependencies,t.token),await async function(e){const t=Pe(e),s=(await Ae()).transaction(De,"readwrite");await s.objectStore(De).delete(t),await s.done}(e.firebaseDependencies));const s=await e.swRegistration.pushManager.getSubscription();return!s||s.unsubscribe()}(e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
