 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F=new Map;function x(e,t){const n=$(e);q(n,t),function(e,t){const n=(!R&&"BroadcastChannel"in self&&(R=new BroadcastChannel("[Firebase] FID Change"),R.onmessage=e=>{q(e.data.key,e.data.fid)}),R);n&&n.postMessage({key:e,fid:t}),0===F.size&&R&&(R.close(),R=null)}(n,t)}function q(e,t){const n=F.get(e);if(n)for(const i of n)i(t)}let R=null;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const H="firebase-installations-store";let W=null;function U(){return W||(W=o("firebase-installations-database",1,{upgrade:(e,t)=>{0===t&&e.createObjectStore(H)}})),W}async function L(e,t){const n=$(e),i=(await U()).transaction(H,"readwrite"),a=i.objectStore(H),o=await a.get(n);return await a.put(t,n),await i.done,o&&o.fid===t.fid||x(e,t.fid),t}async function B(e){const t=$(e),n=(await U()).transaction(H,"readwrite");await n.objectStore(H).delete(t),await n.done}async function V(e,t){const n=$(e),i=(await U()).transaction(H,"readwrite"),a=i.objectStore(H),o=await a.get(n),r=t(o);return void 0===r?await a.delete(n):await a.put(r,n),await i.done,!r||o&&o.fid===r.fid||x(e,r.fid),r}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function z(e){let t;const n=await V(e.appConfig,n=>{const i=function(e){return Y(e||{fid:N(),registrationStatus:0})}(n),a=function(e,t){if(0===t.registrationStatus){if(!navigator.onLine)return{installationEntry:t,registrationPromise:Promise.reject(D.create("app-offline"))};const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},i=async function(e,t){try{const n=
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */await async function({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const i=j(e),a=_(e),o=t.getImmediate({optional:!0});if(o){const e=await o.getHeartbeatsHeader();e&&a.append("x-firebase-client",e)}const r={fid:n,authVersion:C,appId:e.appId,sdkVersion:T},s={method:"POST",headers:a,body:JSON.stringify(r)},c=await A(()=>fetch(i,s));if(c.ok){const e=await c.json();return{fid:e.fid||n,registrationStatus:2,refreshToken:e.refreshToken,authToken:O(e.authToken)}}throw await E("Create Installation",c)}(e,t);return L(e.appConfig,n)}catch(n){throw P(n)&&409===n.customData.serverCode?await B(e.appConfig):await L(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}(e,n);return{installationEntry:n,registrationPromise:i}}return 1===t.registrationStatus?{installationEntry:t,registrationPromise:G(e)}:{installationEntry:t}}(e,i);return t=a.registrationPromise,a.installationEntry});return""===n.fid?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}async function G(e){let t=await J(e.appConfig);for(;1===t.registrationStatus;)await K(100),t=await J(e.appConfig);if(0===t.registrationStatus){const{installationEntry:t,registrationPromise:n}=await z(e);return n||t}return t}function J(e){return V(e,e=>{if(!e)throw D.create("installation-not-found");return Y(e)})}function Y(e){return 1===(t=e).registrationStatus&&t.registrationTime+1e4<Date.now()?{fid:e.fid,registrationStatus:0}:e;var t;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}async function Q({appConfig:e,heartbeatServiceProvider:t},n){const i=function(e,{fid:t}){return`${j(e)}/${t}/authTokens:generate`}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function je(e,t){if(!navigator)throw ye.create("only-available-in-window");if("default"===Notification.permission&&await Notification.requestPermission(),"granted"!==Notification.permission)throw ye.create("permission-blocked");
/**
 * @license
 * Copyright 2020 Google LLC
 *
